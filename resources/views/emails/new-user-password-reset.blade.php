...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>🔑 Nova senha - {{ config('app.name') }}</h1>
        ...
        <div class="content">
            ...
            <p style="margin-bottom: 24px;">
                Sua senha foi redefinida com sucesso no sistema {{ config('app.name') }}! Agora você pode acessar nossa plataforma usando as credenciais abaixo:
            </p>
