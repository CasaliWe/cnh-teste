            ...
            <div class="bg-white bg-opacity-90 rounded-lg p-4 lg:p-6 shadow-lg">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-3 lg:space-y-4" id="loginForm">
                    ...
                    <a 
                        ...
                        class="w-full flex items-center justify-center px-4 py-2.5 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
                    >
